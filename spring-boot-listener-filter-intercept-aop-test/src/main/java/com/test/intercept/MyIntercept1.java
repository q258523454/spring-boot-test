...
public class MyIntercept1 implements HandlerInterceptor {
    ...
    private final Logger log = LoggerFactory.getLogger(MyIntercept1.class);
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        log.info("--------------- 拦截器: MyIntercept1 preHandle() ---------------");
    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler, @Nullable ModelAndView modelAndView) throws Exception {
        log.info("--------------- 拦截器: MyIntercept1 postHandle() ---------------");
    }
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, @Nullable Exception ex) throws Exception {
        log.info("--------------- 拦截器: MyIntercept1 afterCompletion() ---------------");
    }
