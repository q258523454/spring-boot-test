...
// Controller拦截器
public class IpAddressIntercept implements HandlerInterceptor {

    private final Logger logger = LoggerFactory.getLogger(IpAddressIntercept.class);
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        logger.info("--------------- 拦截器: IpAddressIntercept preHandle() ---------------");
        Map<String, String[]> parameterMap = request.getParameterMap();
        logger.info("获取所有的请求parameters");
        ...
        if ("127.0.0.1".equals(ipAddress)) {
            logger.info("ip address is correct.");
        } else {
            logger.info("ip address is error.");
            // return false;
        }
        return true;
    }
    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler, @Nullable ModelAndView modelAndView) throws Exception {
        logger.info("--------------- 拦截器: IpAddressIntercept postHandle() ---------------");
    }
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, @Nullable Exception ex) throws Exception {
        logger.info("--------------- 拦截器: IpAddressIntercept afterCompletion() ---------------");
    }
