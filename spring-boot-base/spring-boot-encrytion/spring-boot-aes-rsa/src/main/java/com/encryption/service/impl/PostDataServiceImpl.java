...
public class PostDataServiceImpl implements PostDataService {
    ...
    Logger logger = LoggerFactory.getLogger(PostDataServiceImpl.class);
    ...
    public StringBuffer postHttpJsonData(String URL, JSONObject jsonObject, JSONObject responseJsonMap, int... timeoutArrays) throws Exception {
        ...
        try {
            ...
            if (response != null && response.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {
                ...
                InputStream in = response.getEntity().getContent(); //Get the data in the global
                ...
                responseJsonMap.put("message", "服务调起异常, 请联系管理员." + "error:" + sb.toString());
            } else {
                responseJsonMap.put("status", "error");
                responseJsonMap.put("message", "服务调起异常, 请联系管理员.");
            }
    ...
    @Override
    public StringBuffer postHttpStringData(String URL, String postData, JSONObject responseJsonMap, int... timeoutArrays) throws Exception {
        ...
        try {
            ...
            post.addHeader("Accept", "application/json");
            post.addHeader("Accept-Encoding", "UTF-8");
            post.addHeader("platform_id", "rxw");
            post.setEntity(params);
