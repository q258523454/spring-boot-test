...
public class KafkaBatchProducerService {
     ...
     * 生产者发送的topic
     */
    public static final String TOPIC = "demo-batch-topic";

    private final KafkaTemplate<String, String> batchKafkaTemplate;

    @Autowired
    public KafkaBatchProducerService(KafkaTemplate<String, String> batchKafkaTemplate) {
    ...
    public void sendMessageWithCallBack(String topic, String message) {
        ListenableFuture<SendResult<String, String>> future = batchKafkaTemplate.send(topic, message);
        // 添加发送结果回调
