...
public class TopicSender {
    ...
    public void sendTopic() {
         ...
         */
        this.amqpTemplate.convertAndSend(TopicConfig.TOPIC_EXCHANGE, "test.msg.zhang", user1);
        this.amqpTemplate.convertAndSend(TopicConfig.TOPIC_EXCHANGE, "test.msg.zhang.xiaofan", user2);
