...
public class DataSourceConfig {
    ...
    public static final String SLAVETRANSACTIONMANAGER = "slaveTransactionManager";
    ...
    public DataSource dbMaster() {
        ...
        druidDataSource.setUrl("jdbc:mysql://99.xx.43.81:3306");
        */
        // 第二种,读取配置自动new DruidDataSource()
        log.info("master数据源");
    ...
    public DataSource dataSourceRouter(@Qualifier("dbMaster") DataSource master, @Qualifier("dbSlave") DataSource slave) {
        ...
        log.info("removeAbandoned 功能: {} ", druidDataSourceMaster.removeAbandoned());
        ...
        log.info("removeAbandoned 功能: {} ", druidDataSourceSlave.removeAbandoned());
