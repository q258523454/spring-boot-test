 ...
 */
@RestController
public class OracleControllerInsert_Batch_AffectRows {
    private static final Logger logger = LoggerFactory.getLogger(OracleControllerInsert_Batch_AffectRows.class);
     ...
     *  2. update batch foreach-case-when 可以返回更新行数
     *  3. begin-end 都无法返回行数
     * --------------------------------------------------------------------------------------------------
     */
