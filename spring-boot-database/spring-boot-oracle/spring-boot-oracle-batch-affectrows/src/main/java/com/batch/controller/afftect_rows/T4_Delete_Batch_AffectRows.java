 ...
 */
@RestController
public class T4_Delete_Batch_AffectRows {
    private static final Logger logger = LoggerFactory.getLogger(T4_Delete_Batch_AffectRows.class);
    ...
    /**
     * 删除:delete .. in(..)
     * @param num 从最大值开始，依次往前删除多少个, 默认一次删除2个
     */
