...
import com.oracle.vs.jdbc.T2_Run2_Oracle_JDBC_Insert_Batch;
...
public class OracleControllerInsertBatch {
     ...
     * 总结:
     *  不考虑返回行数
     *  <5万条数据: 事务下循环单条操作效率 ≈ JDBC原生batch-prepared {@link T2_Run2_Oracle_JDBC_Insert_Batch}
     ...
     * 50000条: 1,007,892,829 ms
     * 100000条: 200,416,991,739 ms
     * JDBC batch-prepared 参考{@link T2_Run2_Oracle_JDBC_Insert_Batch}
     */
